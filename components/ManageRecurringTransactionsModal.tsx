                  ...
                  <div key={rt.id} className="flex items-center justify-between p-3 bg-white border rounded-lg">
                      <div className="flex items-center gap-3">
                        <span className={`w-2 h-8 rounded-full ${isExpense ? '' : 'bg-green-500'}`} style={{ backgroundColor: isExpense ? category?.color : undefined }}></span>
                          <div>
                            <p className="font-semibold text-slate-800">{rt.description}</p>
                      ...
                      <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-1">
                              <button onClick={() => handleEditClick(rt)} className="text-slate-500 hover:text-indigo-600 p-1 rounded-md" aria-label="Modifica">
                                  <PencilSquareIcon className="w-5 h-5" />
                              </button>
                              <button onClick={() => onDelete(rt.id)} className="text-slate-500 hover:text-red-600 p-1 rounded-md" aria-label="Elimina">
